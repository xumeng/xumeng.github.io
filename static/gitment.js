...
var NOT_INITIALIZED_ERROR = exports.NOT_INITIALIZED_ERROR = new Error('文章评论尚未初始化');
...
function renderComments(_ref2, instance) {
  ...
  if (error) {
    ...
    emptyBlock.innerText = '暂无评论，来了就说点什么吧';
